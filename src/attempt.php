...
if(isset($_GET['challenge_id'])){
    ...
    $sql = "SELECT saved_sol FROM saved WHERE challenge_id = '$challenge_id' AND user_id = '$user_id'";
    $result = mysqli_query($con, $sql);
    while($row = $result->fetch_assoc()) {
        $answer = $row["saved_sol"];
    }
}
else{
    echo "Failed";
...
<body>
	...
	<div class="w3-container w3-center" style="margin-top: 50px; width: 100%; margin: auto; ">
		...
		<div class="w3-container" style="width: 60%; height: 80%; text-align: center; padding:10px; margin: auto; display: inline-block; padding-top: 2%;">
			<p><a href='solveChallenge.php?challenge_id=<?php echo $challenge_id ?>'>Go back to question</a></p>
			<br><br>
