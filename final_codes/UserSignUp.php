...
$birthday = $_POST['birthday'];
 ...
 if ($uname != "" && $password != "" && $email != "" && $birthday != ""){

      $sql_check =  $sql_query = "select count(*) as cntUser from general_user where lower(username)='".$uname."'";
...
if($count == 0){
        ...
        $sql_query = "insert into general_user (password, email, username) VALUES (
        ...
        echo $count1;
        //insert to user
        $sql_query2 = "insert into user (id, birth_date) VALUES (
        '".$count1."','".$birthday."' )";
